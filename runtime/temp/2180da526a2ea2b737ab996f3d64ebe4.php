<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"E:\wamp64\www\tp5_360buy\public/../application/index\view\detail\index.html";i:1556191920;s:59:"E:\wamp64\www\tp5_360buy\application\index\view\common.html";i:1556191920;}*/ ?>
		...
		var top1 = new Vue({
			...
			//
				...
				logout: function (){
					...
					$.ajax({
 						url: "http://test.laravel_web.com/api/logout",
 						type: "post",
 						data: {token:token},
 						dataType: "json",
 						success: function(res){
 							...
 							if(res.code == 2000){
 								window.localStorage.removeItem('360_token');
			...
			<div class="summary">
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								...
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo $value['image_url']; ?>',largeimage: '<?php echo $value['image_url']; ?>'}"><img src="<?php echo $value['image_url']; ?>"></a>
								</li>
								<?php endforeach; ?>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="shop_price"><span>本店价：</span> <strong>￥<?php echo $goods['market_price']; ?></strong> <a href="">(降价通知)</a></li>
						<li><span>上架时间：</span><?php echo $goods['shop_time']; ?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="/index/goods/addCart" method="post" class="choose">
						<input type="hidden" name="goods_id" value="<?php echo $goods['id']; ?>">
						<input type="hidden" name="goods_name" value="<?php echo $goods['goods_name']; ?>">
						<input type="hidden" name="goods_img" value="<?php echo $gallery[0]['image_url']; ?>">
						<input type="hidden" name="market_price" value="<?php echo $goods['market_price']; ?>">
						<ul>
							<?php foreach($sku as $k): ?>
							<li class="product">
								<dl>
									<dt><?php echo $k['attr_name']; ?>：</dt>
									<dd>
										<?php foreach($k['attr_sku'] as $key => $attr): ?>
										<a href="javascript:;"><?php echo $attr['sku_value']; ?> <input type="radio" name="attr_sku[<?php echo $key; ?>]" value="<?php echo $attr['sku_id']; ?>" /></a>
										<?php endforeach; ?>
							...
							<li>
								<dl>
									...
									<dd>
										...
										<input type="text" name="nums" value="1" class="amount"/>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								<?php foreach($spu as $pu): ?>
								<li><span><?php echo $pu['attr_name']; ?>：</span><?php echo $pu['sku_value']; ?></li>
								<?php endforeach; ?>
